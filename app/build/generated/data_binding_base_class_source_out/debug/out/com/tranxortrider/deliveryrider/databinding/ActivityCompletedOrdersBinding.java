...
public final class ActivityCompletedOrdersBinding implements ViewBinding {
  ...
  private ActivityCompletedOrdersBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull RecyclerView completedOrdersRecyclerView, @NonNull LinearLayout emptyStateContainer,
      @NonNull TextView emptyStateText, @NonNull HorizontalScrollView filterSection,
      ...
      @NonNull LinearLayout statsSection, @NonNull SwipeRefreshLayout swipeRefreshLayout,
  ...
  public static ActivityCompletedOrdersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.completedOrdersRecyclerView;
      ...
      return new ActivityCompletedOrdersBinding((RelativeLayout) rootView, binding_bottomNav,
          btnDutyStatus, btnNotifications, btnSearch, chipAllOrders, chipCompleted, chipFailed,
          chipInProgress, chipPending, completedOrdersRecyclerView, emptyStateContainer,
          emptyStateText, filterSection, main, notificationCount, profileImage, profileSection,
          statsSection, swipeRefreshLayout, topBar, tvDeliveryCount, tvName, tvOnTimeRate, tvTitle);
    }
